    ...
    render(){
        return(
            <div class="container">
                ...
                {/*Raya Guinda debajo de la navbar */}
                <div class="raya"/>
                <br></br>
                ...
                <button type="button" className="ssmbutton col-4" disabled  onClick={()=> window.location.href="./entradasmate"}>Reporte entradas de material</button>
                <h2>Reportes</h2>
                

               
                <h6><b>Entrada de materiales: </b>Consulta materiales recibidos por fecha</h6>
