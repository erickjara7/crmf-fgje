        ...
        return(
            <div class="container">
                ...
                <Button color="success" onClick={()=>{ 
                    ...
                    this.modalInsertar()}}>Crear Solicitud
                </Button>
                ...
                <Modal isOpen={this.state.modalInsertar}>
                    ...
                    <ModalBody>
                        <div>
                            ...
                            <input class="form-control" type="text" name="solicitante" id="solicitante" readOnly  value={form.solicitante}></input>
                            <br/>
                            ...
                            <input class="form-control" type="text" name="estado" id="estado" readOnly onChange ={this.handleChange} value={form.estado}></input>
                            <br/>
                        </div>
